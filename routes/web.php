...
Route::get('instructor-register', 'AuthController@instructor_register')->name('instructor-register')->middleware('guest');
Route::get('university-register', 'AuthController@university_register')->name('university-register')->middleware('guest');
Route::post('register', 'AuthController@registerPost');
Route::post('instructor-register-post', 'AuthController@instructorRegisterPost')->name('instructor_register_post');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::group(['prefix' => 'cms'], function () {
        ...
        Route::get('get/contact/list', 'PostController@getContactList')->name('getContactList');
        //blog category route
        Route::get('categoty/create/{slug?}', 'BlogcategoryController@create')->name('categoryCreate');
        Route::post('category/data/post', 'BlogcategoryController@store')->name('categoryDataPost');
        Route::get('categoty/all', 'BlogcategoryController@all')->name('categoryAll');
        Route::get('categoty/activate/{slug?}', 'BlogcategoryController@activate')->name('categoryActivate');
        Route::get('categoty/deactivate/{slug?}', 'BlogcategoryController@deactivate')->name('categoryDeactivate');
        Route::get('categoty/delete/{slug?}', 'BlogcategoryController@delete')->name('categoryDelete');
    });
