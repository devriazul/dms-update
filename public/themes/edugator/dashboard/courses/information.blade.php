        ...
        <div class="card-body">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <label for="short_description">Course Duration</label>
                    <div class="input-group">
                        <input type="text" name="course_duration" class="form-control" id="course_duration" placeholder="eg. 1-3 Month" value="{{ $course->course_duration }}" >
                    </div>
                </div>
