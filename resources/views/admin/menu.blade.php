<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            @if(Auth::user()->menu_activity==1 || Auth::user()->menu_activity==0)
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level" style="display: none;">
                    ...
                    <li> <a href="{{ route('categoryAll') }}">Blog Category</a> </li>
                    <li> <a href="{{ route('pages') }}">@lang('admin.pages')</a> </li>
                    <li> <a href="{{ route('getContactList') }}">Contact Query</a> </li>
                </ul><!-- /.nav-second-level -->
            </li>
