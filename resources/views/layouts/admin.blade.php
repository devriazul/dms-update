            ...
            <div id="page-wrapper">
                ...
                <div class="admin-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="m-0"><a href="https://londondms.com" target="_blank">London DMS</a> Version {{config('app.version')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<link rel="stylesheet" href="{{ asset('assets/tags/tagsinput.css') }}">
<script src="{{ asset('assets/tags/tagsinput.js') }}"></script>
