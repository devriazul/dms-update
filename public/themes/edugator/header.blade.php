...
<head>
    ...
    @if(!request()->is('/'))
        ...
        @else
            <meta name="description" content="Digital Marketing School offers a wide range of Digital Marketing, Business Management, Health and Social care online courses covering all aspects you need to advance your career." />
        @endif
    @else
        <meta name="description" content="Digital Marketing School offers a wide range of Digital Marketing, Business Management, Health and Social care online courses covering all aspects you need to advance your career." />
    @endif
