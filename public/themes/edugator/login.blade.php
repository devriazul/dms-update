    ...
    <div class="row justify-content-center">
        <div class="col-md-6 display-hide-xs">
            <div class="login-left-box-img">
                <img src="{{theme_url('images/dms-login-image.webp')}}" alt="login-image">
            </div>
        </div>
        <div class="col-md-6">

            <div class="card dms-login-box">
                ...
                <div class="card-body auth-form-wrap">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-10 offset-md-1">
                                        <button type="submit" class="btn btn-primary dms-login-btn">
                                            {{ __('Login') }}
                                        </button>
                    ...
                    {{-- <div class="row">
                        <div class="col-12 text-center">
                            <h4 class="text-center py-3 pb-0">Or Sign Up Using</h4>
                            <div class="social-login-wrap mb-4 text-center">
                                ...
                                @if(get_option('social_login.twitter.enable'))
                                    <a href="{{ route('twitter_redirect') }}" class="social-login-item btn-twitter">
                                        <span class="hidden-xs"><i class="la la-twitter"></i></span>
                                    </a>
                                @endif
                                ...
                                @if(get_option('social_login.linkedin.enable'))
                                    ...
                                    @if(get_option('social_login.twitter.enable'))
                                        <a href="{{ route('linkedin_redirect') }}" class="social-login-item btn-linkedin">
                                            <span class="hidden-xs"><i class="la la-linkedin-square"></i></span>
                                        </a>
                                    @endif
                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h4 class="text-center py-3 pb-0">Don't have a account?</h4>
                            <a class="btn btn-primary dms-login-btn" href="{{ route('register') }}">
                                {{ __('SIGN UP') }}
                            </a>
                        </div>
                    </div>
